...
func main() {
	x := vcs.GitRepositoryCmd{Dir: "/Users/Dmitri/Dropbox/Work/2013/GoLand/src/github.com/shurcooL/go"}

	fs, err := x.FileSystem("master@{50}")
	if err != nil {
		panic(err)
	}
	...
	case 1:
		fs2 = http.Dir("/Users/Dmitri/Dropbox/Work/2013/GoLand/src/github.com/shurcooL/go")
	}
